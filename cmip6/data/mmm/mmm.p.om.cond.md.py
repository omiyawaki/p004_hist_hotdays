...
def calc_mmm(varn):
    ...
    for i,md in enumerate(tqdm(lmd)):
        ...
        pvn1=xr.open_dataarray('%s/pc.om.%s_%s.%s.nc' % (idir1,varn0,his,se))
        pvn2=xr.open_dataarray('%s/pc.om.%s_%s.%s.nc' % (idir2,varn,fut,se))
        ...
        mvn1.to_netcdf('%s/md.om.%s_%s.%s.nc' % (idir1,varn,his,se))
        mvn2.to_netcdf('%s/md.om.%s_%s.%s.nc' % (idir2,varn,fut,se))
        dmvn.to_netcdf('%s/d.md.om.%s_%s_%s.%s.nc' % (odir0,varn,his,fut,se))
        dpvn.to_netcdf('%s/dpc.md.om.%s_%s_%s.%s.nc' % (odir0,varn,his,fut,se))
        ddpvn.to_netcdf('%s/ddpc.md.om.%s_%s_%s.%s.nc' % (odir0,varn,his,fut,se))
    ...
    mmvn1.to_netcdf('%s/md.om.%s_%s.%s.nc' % (odir1,varn,his,se))
    smvn1.to_netcdf('%s/std.md.om.%s_%s.%s.nc' % (odir1,varn,his,se))
    mmvn2.to_netcdf('%s/md.om.%s_%s.%s.nc' % (odir2,varn,fut,se))
    smvn2.to_netcdf('%s/std.md.om.%s_%s.%s.nc' % (odir2,varn,fut,se))

    mpvn1.to_netcdf('%s/pc.om.%s_%s.%s.nc' % (odir1,varn,his,se))
    spvn1.to_netcdf('%s/std.pc.om.%s_%s.%s.nc' % (odir1,varn,his,se))
    mpvn2.to_netcdf('%s/pc.om.%s_%s.%s.nc' % (odir2,varn,fut,se))
    spvn2.to_netcdf('%s/std.pc.om.%s_%s.%s.nc' % (odir2,varn,fut,se))

    mdmvn.to_netcdf('%s/d.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
    sdmvn.to_netcdf('%s/std.d.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))

    mdpvn.to_netcdf('%s/dpc.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
    sdpvn.to_netcdf('%s/std.dpc.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))

    mddpvn.to_netcdf('%s/ddpc.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
    sddpvn.to_netcdf('%s/std.ddpc.md.om.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
