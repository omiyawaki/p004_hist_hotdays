...
def calc_mmm(varn):
    ...
    mpvn1.to_netcdf('%s/cd.%s_%s.%s.nc' % (odir1,varn,his,se))
    mpvn2.to_netcdf('%s/cd.%s_%s.%s.nc' % (odir2,varn,fut,se))
    spvn1.to_netcdf('%s/std.cd.%s_%s.%s.nc' % (odir1,varn,his,se))
    spvn2.to_netcdf('%s/std.cd.%s_%s.%s.nc' % (odir2,varn,fut,se))

    mdvn.to_netcdf('%s/cd.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
    sdvn.to_netcdf('%s/std.cd.%s_%s_%s.%s.nc' % (odir,varn,his,fut,se))
