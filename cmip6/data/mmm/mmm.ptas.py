...
for i,md in enumerate(tqdm(lmd)):
    idir1 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo1,md,varn)
    idir2 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo2,md,varn)
...
# save mmm and std
odir1 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo1,'mmm',varn)
odir2 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo2,'mmm',varn)
odir = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo,'mmm',varn)
...
# # save ensemble
# odir1 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo1,'mi',varn)
# odir2 = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo2,'mi',varn)
# odir = '/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s' % (se,fo,'mi',varn)
# if not os.path.exists(odir1):
#     os.makedirs(odir1)
# if not os.path.exists(odir2):
#     os.makedirs(odir2)
