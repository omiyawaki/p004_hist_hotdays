...
for i,md in enumerate(tqdm(lmd)):
    ...
    # prc temp
    ds1=xr.open_dataset('%s/p.%s%03d_%s.%s.nc' % (idir1,varn,nt,his,se))
    pct=ds1['percentile']
    print(pct)
    gr['pct']=pct
    try:
    ...
    ds2=xr.open_dataset('%s/p.%s%03d_%s.%s.nc' % (idir2,varn,nt,fut,se))
    try:
        pvn2=ds2[varn]
    except:
...
pickle.dump([mvn1,svn1,gr], open('%s/m%s_%s.%s.pickle' % (odir1,varn,his,se), 'wb'), protocol=5)	
pickle.dump([mvn2,svn2,gr], open('%s/m%s_%s.%s.pickle' % (odir2,varn,fut,se), 'wb'), protocol=5)	
pickle.dump([mpvn1,spvn1,gr], open('%s/p%s_%s.%s.pickle' % (odir1,varn,his,se), 'wb'), protocol=5)	
pickle.dump([mpvn2,spvn2,gr], open('%s/p%s_%s.%s.pickle' % (odir2,varn,fut,se), 'wb'), protocol=5)	
pickle.dump([mdvn,sdvn,gr], open('%s/d%s_%s_%s.%s.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump([mdpvn,sdpvn,gr], open('%s/dp%s_%s_%s.%s.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump([mddpvn,sddpvn,gr], open('%s/ddp%s_%s_%s.%s.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
...
pickle.dump(ivn1, open('%s/m%s_%s.%s.pickle' % (odir1,varn,his,se), 'wb'), protocol=5)	
pickle.dump(ivn2, open('%s/m%s_%s.%s.pickle' % (odir2,varn,fut,se), 'wb'), protocol=5)	
