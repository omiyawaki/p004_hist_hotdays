...
odir = '/project/amp02/miyawaki/data/p004/cmip6/%s/%s/%s/%s/%s' % (se,cl,fo,'mmm',varn)
...
pickle.dump([mpvn1,spvn1,gr], open('%s/p%s_%s.%s.doy.pickle' % (odir1,varn,his,se), 'wb'), protocol=5)	
pickle.dump([mpvn2,spvn2,gr], open('%s/p%s_%s.%s.doy.pickle' % (odir2,varn,fut,se), 'wb'), protocol=5)	
pickle.dump([mdvn,sdvn,gr], open('%s/d%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump([mdpvn,sdpvn,gr], open('%s/dp%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump([mddpvn,sddpvn,gr], open('%s/ddp%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
...
odir = '/project/amp02/miyawaki/data/p004/cmip6/%s/%s/%s/%s/%s' % (se,cl,fo,'mi',varn)
if not os.path.exists(odir1):
    os.makedirs(odir1)
if not os.path.exists(odir2):
    os.makedirs(odir2)
...
pickle.dump(ipvn1, open('%s/p%s_%s.%s.doy.pickle' % (odir1,varn,his,se), 'wb'), protocol=5)	
pickle.dump(ipvn2, open('%s/p%s_%s.%s.doy.pickle' % (odir2,varn,fut,se), 'wb'), protocol=5)	
pickle.dump(idvn, open('%s/d%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump(idpvn, open('%s/dp%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
pickle.dump(iddpvn, open('%s/ddp%s_%s_%s.%s.doy.pickle' % (odir,varn,his,fut,se), 'wb'), protocol=5)	
