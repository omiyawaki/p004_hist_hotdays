...
def calc_gradt(md):
    ...
    vn=vn.ffill(dim='lat')
    vn=vn.bfill(dim='lat')
    vn=vn.ffill(dim='dayofyear')
    vn=vn.bfill(dim='dayofyear')
    ...
    dxm=xr.DataArray(dxm,name='dx',coords={'dayofyear':doy,'lat':latmd,'lon':lonmd},dims=('dayofyear','lat','lon'))
    dym=xr.DataArray(dym,name='dy',coords={'dayofyear':doy,'lat':latmd,'lon':lonmd},dims=('dayofyear','lat','lon'))
