...
for pc in lpc:
    for se in lse:
        ...
        for imd in tqdm(range(len(lmd))):
            ...
            # del BC contrib
            vn2c1 = pickle.load(open('%s/pc.devdbc%s_%s.%g.%g.%s.pickle' % (idir2c1,varn2,his,ila,ilo,se), 'rb'))
            vn2c2 = pickle.load(open('%s/pc.devdbc%s_%s.%g.%g.%s.pickle' % (idir2c2,varn2,fut,ila,ilo,se), 'rb'))
            # hist BC contrib
            vn3c1 = pickle.load(open('%s/pc.devbc%s_%s.%g.%g.%s.pickle' % (idir2c1,varn2,his,ila,ilo,se), 'rb'))
            vn3c2 = pickle.load(open('%s/pc.devbc%s_%s.%g.%g.%s.pickle' % (idir2c2,varn2,fut,ila,ilo,se), 'rb'))
            # del SM contrib
            vn4c1 = pickle.load(open('%s/pc.devcsm%s_%s.%g.%g.%s.pickle' % (idir2c1,varn2,his,ila,ilo,se), 'rb'))
            vn4c2 = pickle.load(open('%s/pc.devcsm%s_%s.%g.%g.%s.pickle' % (idir2c2,varn2,fut,ila,ilo,se), 'rb'))
            # hist SM contrib
            vn5c1 = pickle.load(open('%s/pc.devhistcsm%s_%s.%g.%g.%s.pickle' % (idir2c1,varn2,his,ila,ilo,se), 'rb'))
            vn5c2 = pickle.load(open('%s/pc.devhistcsm%s_%s.%g.%g.%s.pickle' % (idir2c2,varn2,fut,ila,ilo,se), 'rb'))
        ...
        pickle.dump(ev, open('%s/ev.dpred.d%s.act.d%s.%s.%g.%s.pickle' % (odir,varn,his,fut,pc,se), 'wb'), protocol=5)	
