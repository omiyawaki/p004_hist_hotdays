...
for pc in lpc:
    for se in lse:
        ...
        for imd in tqdm(range(len(lmd))):
            ...
            vn1c1 = pickle.load(open('%s/pc%s_%s.%s.dev.pickle' % (idir2c1,varn2,his,se), 'rb'))
            vn1c2 = pickle.load(open('%s/pc%s_%s.%s.dev.pickle' % (idir2c2,varn2,fut,se), 'rb'))
            # del BC contrib
            vn2c1 = pickle.load(open('%s/pc.devdbc%s_%s.%s.dev.pickle' % (idir2c1,varn2,his,se), 'rb'))
            vn2c2 = pickle.load(open('%s/pc.devdbc%s_%s.%s.dev.pickle' % (idir2c2,varn2,fut,se), 'rb'))
            # hist BC contrib
            vn3c1 = pickle.load(open('%s/pc.devbc%s_%s.%s.dev.pickle' % (idir2c1,varn2,his,se), 'rb'))
            vn3c2 = pickle.load(open('%s/pc.devbc%s_%s.%s.dev.pickle' % (idir2c2,varn2,fut,se), 'rb'))
            # del SM contrib
            vn4c1 = pickle.load(open('%s/pc.devcsm%s_%s.%s.dev.pickle' % (idir2c1,varn2,his,se), 'rb'))
            vn4c2 = pickle.load(open('%s/pc.devcsm%s_%s.%s.dev.pickle' % (idir2c2,varn2,fut,se), 'rb'))
            # hist SM contrib
            vn5c1 = pickle.load(open('%s/pc.devhistcsm%s_%s.%s.dev.pickle' % (idir2c1,varn2,his,se), 'rb'))
            vn5c2 = pickle.load(open('%s/pc.devhistcsm%s_%s.%s.dev.pickle' % (idir2c2,varn2,fut,se), 'rb'))
        ...
        pickle.dump(ev, open('%s/ev.dpred.%s.act.%s.%s.%g.%s.dev.pickle' % (odir,varn,his,fut,pc,se), 'wb'), protocol=5)	
