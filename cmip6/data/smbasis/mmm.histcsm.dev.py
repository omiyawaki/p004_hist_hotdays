...
for se in lse:
    ...
    pickle.dump(sm1, open('%s/pc%s_%s.%s.dev.pickle' % (odir1,varn,yr1,se), 'wb'), protocol=5)	
    pickle.dump(sm2, open('%s/pc%s_%s.%s.dev.pickle' % (odir2,varn,yr2,se), 'wb'), protocol=5)	
