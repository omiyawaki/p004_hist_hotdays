...
for se in lse:
    ...
    for imd in tqdm(range(len(lmd))):
        ...
        if cl=='his':
            ...
            [delef,_]=pickle.load(open('%s/d%s_%s.%s.%s.pickle' % (idir1,varn,'1980-2000',yr,se), 'rb'))
            ef=ef0+delef
        ...
        pickle.dump(pef, open('%s/pc.devbc%s_%s.%s.pickle' % (odir,varn1,yr,se), 'wb'), protocol=5)	
