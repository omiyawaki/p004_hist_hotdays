        ...
        for fo in lfo:
            for cl in lcl:
                ...
                for imd in tqdm(range(len(lmd))):
                    ...
                    rdir='/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s/%s' % (se,'his','historical',md,varn)
                    rdirt='/project/amp/miyawaki/data/p004/cmip6/%s/%s/%s/%s/%s' % (se,'his','historical',md,'tas')
