        ...
        for fo in lfo:
            for se in lse:
                ...
                for imd in tqdm(range(len(lmd))):
                    ...
                    hdir=mdir(se,'his','historical',md,varn0)
                    fdir=mdir(se,'fut',fo,md,varn0)
                    odir=mdir(se,cl,fo,md,varn0)
                    ...
                    [ht2m0, gr] = pickle.load(open('%s/c%s_%s.%s.rg.pickle' % (mdir(se,'his','historical',md,varn0),varn,his,se), 'rb'))
                    [ht2m1, gr] = pickle.load(open('%s/c%s_%s.%s.rg.pickle' % (mdir(se,'fut',fo,md,varn0),varn,fut,se), 'rb'))
