        ...
        for fo in lfo:
            ...
            for md in lmd:
                ...
                if md=='mmm':
                    ...
                    # cb.set_label(r'$\sigma\left(\frac{(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}}{(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}}\right)$ (unitless)' % (pc,fut,pc,his))
                    ...
                    ax.set_title(r'%s %s %s' % (se.upper(),md.upper(),fo.upper()))
                    cb=plt.colorbar(clf,location='bottom')
                    cb.set_label(r'$\sigma((SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}-(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s})$ (W m$^{-2}$)' % (pc,fut,pc,his))
                ...
                # ax.set_title(r'%s %s %s' % (se.upper(),md.upper(),fo.upper()))
                # cb=plt.colorbar(clf,location='bottom')
                # cb.set_label(r'$\frac{(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}}{(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}}$ (unitless)' % (pc,fut,pc,his))
                ...
                ax.set_title(r'%s %s %s' % (se.upper(),md.upper(),fo.upper()))
                cb=plt.colorbar(clf,location='bottom')
                cb.set_label(r'$(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}-(SH^{>%s}_\mathrm{2\,m}-\overline{SH}_\mathrm{2\,m})_\mathrm{%s}$ (W m$^{-2}$)' % (pc,fut,pc,his))
