        ...
        for fo in lfo:
            ...
            for md in lmd:
                ...
                if md=='mmm':
                    ...
                    if pc==0:
                        cb.set_label(r'$\sigma(\Delta \overline{LH}_\mathrm{2\,m})$ (W m$^{-2}$)')
                    else:
                        cb.set_label(r'$\sigma(\Delta LH^{>%s}_\mathrm{2\,m})$ (W m$^{-2}$)' % (pc))
                ...
                cb=plt.colorbar(clf,location='bottom')
                if pc==0:
                    cb.set_label(r'$\Delta \overline{LH}_\mathrm{2\,m}$ (W m$^{-2}$)')
                else:
                    cb.set_label(r'$\Delta LH^{>%s}_\mathrm{2\,m}$ (W m$^{-2}$)' % (pc))
