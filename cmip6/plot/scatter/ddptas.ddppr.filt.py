...
for args in largs:
    ...
    if mmm:
        ...
        if ann:
            ...
            # abm=np.vstack([86400*mm2.flatten(),mm1.flatten()])
            # cpdf=np.reshape(kde(abm).T,mm1.shape)
            # clf=ax.scatter(86400*mi2,mi1,s=0.1,c='k')
            # clf=ax.scatter(86400*mi2,mi1,s=0.1,c=86400*mi3)
        ...
        if ann:
            ...
            # abm=np.vstack(stack)
            # pdf=kde(abm)
            ax[-1].scatter(86400*mi2,mi1,s=0.1,c=86400*mi3)
