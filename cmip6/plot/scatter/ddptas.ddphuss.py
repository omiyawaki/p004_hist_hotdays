...
for args in largs:
    ...
    if mmm:
        ...
        if ann:
            ...
            ax.set_xlabel('$\Delta\delta{q}^{%02d}$ (kg kg$^{-1}$)'%p)
            ...
            for mon in range(12):
                ...
                ax[mon].set_xlabel('$\Delta\delta{q}^{%02d}$ (kg kg$^{-1}$)'%p)
        ...
        if ann:
            ...
            ax[-1].set_xlabel('$\Delta\delta{q}^{%02d}$ (kg kg$^{-1}$)'%p)
            ...
            for imd,md in enumerate(lmd):
                ...
                ax[imd].set_xlabel('$\Delta\delta{q}^{%02d}$ (kg kg$^{-1}$)'%p)
