...
p=95
b1=np.arange(0,10+0.1,0.1) # bins of vn1
pref1='ddp'
varn1='tas'
pref2='ddp'
varn2='pr'
...
for args in largs:
    ...
    if mmm:
        ...
        if ann:
            ...
            # bin
            dg=np.digitize(mi1,b1)
            b2=[86400*mi2[dg==i].mean() for i in range(1,len(b1)+1)]
            ...
            fig.savefig('%s.ann.bin.pdf'%oname, format='pdf', dpi=300)
        ...
        if ann:
            ...
            fig.savefig('%s.ann.mi.bin.pdf'%oname, format='pdf', dpi=300)
