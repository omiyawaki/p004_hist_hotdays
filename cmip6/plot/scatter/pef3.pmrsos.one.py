...
pref4='p'
varn4='tas'
varn='%s%s+%s%s'%(pref1,varn1,pref3,varn2)
se = 'sc'
...
ri2=pickle.load(open('%s/%s%s_%s.%s.pickle' % (idir2,pref3,varn2,yr,se), 'rb'))
...
for re in lre:
    ...
    if mmm:
        ...
        if ann:
            ...
            ax.set_ylabel(r'$\frac{LH}{SW_\mathrm{net}+LW_\mathrm{down}}$ (unitless)')
            # ax.set_xlim([0,50])
            ax.set_ylim([0,1.2])
            ...
            for mon in range(12):
                ...
                ax[mon].set_ylabel(r'$\frac{LH}{SW_\mathrm{net}+LW_\mathrm{down}}$ (unitless)')
        ...
        if ann:
            ...
            ax[-1].set_ylabel(r'$\frac{LH}{SW_\mathrm{net}+LW_\mathrm{down}}$ (unitless)')
            ax[-1].set_xlim([0,50])
            ax[-1].set_ylim([0,1])
            ...
            for imd2,md2 in enumerate(lmd):
                ...
                ax[imd2].set_ylabel(r'$\frac{LH}{SW_\mathrm{net}+LW_\mathrm{down}}$ (unitless)')
