...
for re in lre:
    ...
    if mmm:
        ...
        if ann:
            ...
            ax.set_ylabel(r'$\frac{LH}{LH+SH}$ (unitless)')
            # ax.set_xlim([0,50])
            ax.set_ylim([0,1.2])
            ...
            for mon in range(12):
                ...
                ax[mon].set_ylabel(r'$\frac{LH}{LH+SH}$ (unitless)')
        ...
        if ann:
            ...
            ax[-1].set_ylabel(r'$\frac{LH}{LH+SH}$ (unitless)')
            ax[-1].set_xlim([0,50])
            ax[-1].set_ylim([0,1])
            ...
            for imd2,md2 in enumerate(lmd):
                ...
                ax[imd2].set_ylabel(r'$\frac{LH}{LH+SH}$ (unitless)')
