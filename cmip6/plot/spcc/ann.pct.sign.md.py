...
def plot():
    ...
    fig.savefig('%s/ann.%s.%s%s.ah.pct.reg.md.png'%(odir1,varn1,fo,fstr),format='png',dpi=600)
    ...
    fig.savefig('%s/ann.%s.%s%s.ah.pct.sign.md.png' % (odir1,varn1,fo,fstr), format='png', dpi=600)
    fig.savefig('%s/ann.%s.%s%s.ah.pct.sign.md.pdf' % (odir1,varn1,fo,fstr), format='pdf', dpi=600)
