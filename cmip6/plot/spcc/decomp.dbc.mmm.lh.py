...
def plot():
    ...
    ooplh_dbc=load_vn('ooplh_dbc')
    ooplh_rbcsm=load_vn('ooplh_rbcsm')
    ...
    ooplh_dbc=remap(ooplh_dbc)
    ooplh_rbcsm=remap(ooplh_rbcsm)
    ...
    ooplh_dbc=pshift(ooplh_dbc)
    ooplh_rbcsm=pshift(ooplh_rbcsm)
    ...
    ooplh_dbc=extend(ooplh_dbc)
    ooplh_rbcsm=extend(ooplh_rbcsm)
    ld=[ooplh,ooplh_fixbc,ooplh_dbc,ooplh_rbcsm] # store in list
    ls=[vstr('ooplh'),vstr('ooplh_fixbc'),vstr('ooplh_dbc'),vstr('ooplh_rbcsm')]
