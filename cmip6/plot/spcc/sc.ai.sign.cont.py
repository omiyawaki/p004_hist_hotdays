...
def plot(re):
    ...
    for ct in lct:
        try:
            ...
            pai=np.nanpercentile(cmai,lpai)
            iai=np.digitize(cmai,pai)
            cahddp1,stdev=binned(cahddp1,ahw,iai)
            cahddpe=ebinned(cahddpe,ahw,iai)
            ...
            fig.savefig('%s/sc.ddp%02d%s.%s%s.ah.ai.sign.%s.%s.png' % (odir1,p,varn1,fo,fstr,re,ct[0]), format='png', dpi=600,backend='pgf')
            fig.savefig('%s/sc.ddp%02d%s.%s%s.ah.ai.sign.%s.%s.pdf' % (odir1,p,varn1,fo,fstr,re,ct[0]), format='pdf', dpi=600,backend='pgf')
            ...
            fig.savefig('%s/stdev.sc.ddp%02d%s.%s%s.ah.ai.sign.%s.%s.png' % (odir1,p,varn1,fo,fstr,re,ct[0]), format='png', dpi=600,backend='pgf')
            fig.savefig('%s/stdev.sc.ddp%02d%s.%s%s.ah.ai.sign.%s.%s.pdf' % (odir1,p,varn1,fo,fstr,re,ct[0]), format='pdf', dpi=600,backend='pgf')
