...
def plot():
    ...
    fig.savefig('%s/ann.%s.%s%s.ah.pct.sign.a.png' % (odir1,varn1,fo,fstr), format='png', dpi=600)
    fig.savefig('%s/ann.%s.%s%s.ah.pct.sign.a.pdf' % (odir1,varn1,fo,fstr), format='pdf', dpi=600)
