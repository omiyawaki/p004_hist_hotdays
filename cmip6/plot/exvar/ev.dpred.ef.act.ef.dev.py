...
for pc in lpc:
    for se in lse:
        ...
        ev=pickle.load(open('%s/ev.dpred.%s.act.%s.%s.%g.%s.dev.pickle' % (idir,varn,his,fut,pc,se),'rb'))
        ...
        cb.set_label(r'$R^2$')
        plt.savefig('%s/ev.act.dpred.%s.%g.%s.all.dev.pdf' % (odir,varn,pc,se), format='pdf', dpi=300)
        plt.close()
        ...
        cb=plt.colorbar(clf,location='bottom')
        cb.set_label(r'$R^2$')
        plt.savefig('%s/ev.act.dpred.%s.%g.%s.dbc.dev.pdf' % (odir,varn,pc,se), format='pdf', dpi=300)
        plt.close()
        ...
        cb=plt.colorbar(clf,location='bottom')
        cb.set_label(r'$R^2$')
        plt.savefig('%s/ev.act.dpred.%s.%g.%s.cbc.dev.pdf' % (odir,varn,pc,se), format='pdf', dpi=300)
        plt.close()
        ...
        cb=plt.colorbar(clf,location='bottom')
        cb.set_label(r'$R^2$')
        plt.savefig('%s/ev.act.dpred.%s.%g.%s.dsm.dev.pdf' % (odir,varn,pc,se), format='pdf', dpi=300)
        plt.close()
        ...
        cb=plt.colorbar(clf,location='bottom')
        cb.set_label(r'$R^2$')
        plt.savefig('%s/ev.act.dpred.%s.%g.%s.csm.dev.pdf' % (odir,varn,pc,se), format='pdf', dpi=300)
        plt.close()
