    ...
    for se in lse:
        ...
        for imd in tqdm(range(len(lmd))):
            ...
            if c==0:
                ...
                fig1.supylabel(r'Deseasonalized $SW^{\uparrow}_{SFC}$ (W m$^{-2}$)')
                ...
                fig2.supylabel(r'Deseasonalized $SW^{\uparrow}_{SFC}$ (W m$^{-2}$)')
                ...
                fig3.supylabel(r'$\Delta SW^{\uparrow}_{SFC}$ (W m$^{-2}$)')
